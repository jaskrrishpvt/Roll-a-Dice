...
export default function Main() {
  const programName = 'dice_roll_program';
  ...
  return (
    <div>
      ...
      <br />
      <h1>3. Roll the Dice {storeId_my_int1 && storeId_my_int2 && ' ✅'}</h1>
      {userId && programId && (
        <>
          <h2>Predict the value {storeId_my_int1 && ' ✅'}</h2>
          <StoreSecretForm
            secretName={'my_int1'}
          ...
          <h2>Dice Rolling ... {storeId_my_int2 && ' ✅'}</h2>
          <StoreSecretForm
            secretName={'my_int2'}
